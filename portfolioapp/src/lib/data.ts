...
export const projects: Project[] = [
  {
    ...
    summary: "취업 준비생을 위한 구직관리 애플리케이션",
    description:
        ...
        implementations: [
          {
            ...
            solutions:
              "Axios 응답 인터셉터를 활용해 401 Unauthorized 응답 시 Refresh 토큰으로 새로운 Access 토큰을 요청하도록 구현",
          },
          {
            title: "CSRF 공격 방어",
            description:
              " LocalStorage 기반 상태 관리를 활용한 OAuth 보안 취약점 해결",
            technologies: ["React", "Tailwind", "localStorage"],
            challenges: "CSRF 방지",
            solutions:
              "localStorage에 state 파라미터를 저장하는 방식으로 인증 로직을 구현하여 CSRF 공격 방지",
          },
        ],
      },
      {
        ...
        implementations: [
          {
            ...
            solutions:
              "React Query의 무한스크롤 기능을 활용 데이터를 불러오는 시점을 조절하여 렌더링 속도 향상",
          },
        ],
      },
      {
        ...
        implementations: [
          {
            ...
            challenges:
              "검색 페이지와 관심 페이지 간 공통 상태 및 액션 관리의 어려움",
        ...
        implementations: [
          {
            ...
            challenges:
              "지원 데이터 업데이트 요청 이후 기존 캐싱 데이터 사용 시 데이터 불일치 문제",
            solutions:
              "React Query의 캐싱 기능을 활용하여 최신 지원 데이터 상태 관리",
          },
        ],
      },
      {
        ...
        implementations: [
          ...
          },
          {
            ...
            solutions:
              "lodash의 debounce 함수를 활용하여 검색 이벤트 발생 시 최소 호출 구현",
          },
        ],
      },
      {
        ...
        implementations: [
          {
            ...
            technologies: ["React", "Tailwind", "Zustand"],
            challenges:
              "선택한 공고 ID를 통해 노트 컴포넌트에 데이터 전달 및 노트 컴포넌트에서 데이터 사용",
  ...
  },
  {
    ...
    summary: "PeerNow 프로젝트를 리팩토링하여 더 나은 코드 구조로 개선",
    description:
        ...
        implementations: [
          {
            title: "타입스크립트 적용",
            description:
              "기존 JS 기반으로 구현한 PeerNow 프로젝트를 TypeScript로 리팩토링(메인페이지)",
            technologies: ["React", "TypeScript", "Tailwind"],
            challenges:
              "기존 JS 기반으로 구현한 PeerNow 프로젝트를 TypeScript로 리팩토링",
            solutions:
              "TypeScript로 리팩토링하여 런타임 오류 방지 및 코드 가독성 향상",
          },
        ],
      },
    ],
        ...
        implementations: [
          {
            ...
            challenges:
              "Project(사용자 정보, 참여 프로젝트 정보)를 각각의 페이지 컴포넌트에서 사용",
            solutions:
              "Zustand를 활용하여 전역 상태를 관리하여 Props Drilling 문제 해결",
          },
          {
            title: "서버 상태 구현",
